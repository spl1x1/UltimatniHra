...
#ifndef ULTIMATNIHRA_SLIMESPRITE_FIRE_H
#define ULTIMATNIHRA_SLIMESPRITE_FIRE_H
#include "Sprite.hpp"

class SlimeSprite_Fire final : public ISprite{
    SpriteRenderingContext renderingContext = SpriteRenderingContext("Slime3",0.2f, 64, 64, Direction::DOWN, AnimationType::IDLE);
public:
    //Interface Methods
...
#endif //ULTIMATNIHRA_SLIMESPRITE_FIRE_H