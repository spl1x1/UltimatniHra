...
#ifndef ULTIMATNIHRA_SLIMESPRITE_GHOST_H
#define ULTIMATNIHRA_SLIMESPRITE_GHOST_H
#include "Sprite.hpp"

class SlimeSprite_Ghost final : public ISprite{
    SpriteRenderingContext renderingContext = SpriteRenderingContext("Slime2",0.2f, 64, 64, Direction::DOWN, AnimationType::IDLE);
public:
    //Interface Methods
...
#endif //ULTIMATNIHRA_SLIMESPRITE_GHOST_H